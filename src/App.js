...
const homeFieldGoal= score=>(setHomeScore +3);
const homeTouchDown=score=>(setHomeScore +7);
const awayFieldGoal =score=> (setAwayScore +3);
const awayTouchDown=score=> (setHomeScore +7);
